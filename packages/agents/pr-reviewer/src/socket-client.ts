/**
 * TypeScript Socket Client for PR Reviewer Agent
 * Unix socket IPC communication with the orchestrator
 */

import { createConnection, Socket } from 'net';
import { EventEmitter } from 'events';
import { PRReviewerCapabilities, PRReviewerTaskData } from './types.js';
...
export class PRReviewerSocketClient extends EventEmitter {
